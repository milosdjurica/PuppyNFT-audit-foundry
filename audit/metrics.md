...
| ---- | ------ | --------------- | ---------- | ----- | ------ | ----- | ------------- | -------------- | ------------ | 
| 📝 | src\PuppyRaffle.sol | 1 | **** | 250 | 236 | 132 | 80 | 111 | **<abbr title='Payable Functions'>💰</abbr><abbr title='Uses Hash-Functions'>🧮</abbr>** |
| 📝 | **Totals** | **1** | **** | **250**  | **236** | **132** | **80** | **111** | **<abbr title='Payable Functions'>💰</abbr><abbr title='Uses Hash-Functions'>🧮</abbr>** |
...
- **Comment-to-Source Ratio:** On average there are`1.79` code lines per comment (lower=better).
- **ToDo's:** `1` 
